...
import styles from "./BedSheets.module.css";

const BedSheets = (props) => {
  const [path, setPath] = useState("product3");
  ...
  return (
    <div className={styles.featuredProductsContainer}>
      <div className={styles.featuredProduct}>
        <NavLink to={`/${path}`}>
          <div className={styles.imgContainer}>
            <img src={product3} alt="product3" ref={firstImg} />
            <button
      ...
      <div className={styles.featuredProduct}>
        <NavLink to={`/${path}`}>
          <div className={styles.imgContainer}>
            <img src={product3} alt="product3" ref={secondImg} />
            <button
              className={styles.addRemoveButton}
              onClick={(e) => {
                props.addProduct();
      ...
      <div className={styles.featuredProduct}>
        <NavLink to={`/${path}`}>
          <div className={styles.imgContainer}>
            <img src={product3} alt="product3" ref={thirdImg} />
            <button
              className={styles.addRemoveButton}
              onClick={(e) => {
                props.addProduct();
      ...
      <div className={styles.featuredProduct}>
        <NavLink to={`/${path}`}>
          <div className={styles.imgContainer}>
            <img src={product3} alt="product3" ref={fourthImg} />
            <button
              className={styles.addRemoveButton}
              onClick={(e) => {
                props.addProduct();
